...
interface BudgetsContextValue {
  budgets: Budget[]
  loading: boolean
  addBudget: (budget: Omit<Budget, 'id' | 'accumulated' | 'committed' | 'is_active'>) => Promise<{ ok: boolean; error?: string }>
  addMovement: (budgetId: string, amount: number, note?: string) => Promise<void>
  addCommitment: (budgetId: string, amount: number, note?: string) => Promise<void>
  deleteBudget: (id: string) => Promise<void>
  resetBudget: (id: string) => Promise<{ ok: boolean; error?: string }>
  distributeSalary: (salaryAmount: number) => Promise<{ totalDistributed: number; budgetCount: number } | undefined>
